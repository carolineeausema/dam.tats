    ...
    <SnapScroller>
      <RevealSection className="flex flex-col md:flex-row md:items-stretch">
        <Image
          ...
          className="h-auto max-h-[45dvh] w-auto max-w-full flex-shrink-0 object-contain md:h-[100dvh] md:max-h-none md:w-auto md:max-w-[42%] lg:max-w-[50%]"
        />
      ...
      <RevealSection className="flex flex-col md:flex-row md:items-stretch">
        ...
        <Image
          ...
          height={1200}
          sizes="(min-width: 768px) 55vw, 100vw"
          className="h-auto max-h-[45dvh] w-auto max-w-full flex-shrink-0 object-contain md:h-[100dvh] md:max-h-none md:w-auto md:max-w-[50%]"
        />
      </RevealSection>
    </SnapScroller>
  );
